...
public class Empleado {
    ...
    public void DatosNacimiento() {
        System.out.println("Nombre: " + this.nombre);
        System.out.println("Fecha de Nacimiento: " + fechaN.getAnio() + "/" + fechaN.getMes() + "/" + fechaN.getDia());
    }
    
    public void DatosIngresoEmpresa() {
        System.out.println("Fecha de Ingreso a la Empresa: " + fechaI.getAnio() + "/" + fechaI.getMes() + "/" + fechaI.getDia());
    }
    
    public void Anios(int dia, int mes, int anio) {
    ...
    public void Meses(int dia, int mes, int anio) {
        GregorianCalendar fecha = new GregorianCalendar(anio, mes - 1, dia);
        int cont = 0;
        int mtotales = 0;
        GregorianCalendar fechaActual = new GregorianCalendar();
    ...
    public void Dias(int dia, int mes, int anio) {
        GregorianCalendar fecha = new GregorianCalendar(anio, mes - 1, dia);
        int cont = 0;
        int dtotales = 0;
        GregorianCalendar fechaActual = new GregorianCalendar();
